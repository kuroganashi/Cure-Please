  ...
  public partial class Form4 : Form
  {
    ...
    public Form4(Form1 f)
    {
      ...
      if (f1.setinstance2.Enabled == true)
      {
        ...
        instancePrimary = new EliteAPI((int)f1.activeProcessIds.SelectedItem);
        characterNamed_label.Text = "Chatlog for character: " + instancePrimary.Player.Name + "\n";

        var cl = new EliteAPI.ChatEntry();

        while ((cl = instancePrimary.Chat.GetNextChatLine()) != null)
        {
    ...
    {
      instancePrimary.ThirdParty.SendString(ChatLogMessage_textfield.Text);
