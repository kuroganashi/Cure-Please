namespace CurePlease
{
    partial class Form2
    {
        ...
        "d in combat.");
			...
			this.GEOSpell_target.TextChanged += new System.EventHandler(this.GEOSpell_target_TextChanged);
			// 
			// marcato
			// 
    ...
    "rePlease \r\nCTRL + ALT + F3            Pause CurePlease";
			...
			this.trackCastingPackets.Checked = true;
			this.trackCastingPackets.CheckState = System.Windows.Forms.CheckState.Checked;
    ...
    "mization.";
			...
			this.enableAddOn.Checked = true;
			this.enableAddOn.CheckState = System.Windows.Forms.CheckState.Checked;
